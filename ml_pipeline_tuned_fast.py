...
def run_tuned_pipeline_fast():
    ...
    plt.title('Tuned Models ROC Curve (Fast)')
    plt.legend(loc="lower right")
    plt.grid(True)
    plt.savefig("roc_curves_tuned_fast.png")
    print("Tuned ROC curve plot saved as roc_curves_tuned_fast.png")

if __name__ == "__main__":
    run_tuned_pipeline_fast()
